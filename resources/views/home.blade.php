...
<body>
    ...
    <div class="bg-blue-500 w-full px-0 py-5">
        <img src="{{ asset('public/images/logo.png') }}" alt="" class="h-[35px] w-auto mx-auto px-4">
    </div>
    ...
    <div class="w-full text-center py-5 bg-blue-500 text-xl text-white font-semibold">
